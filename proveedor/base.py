# -*- coding: utf-8 -*-
from flask import request, session, url_for # importe de metodos para utilizar de flask
from requests_oauthlib import OAuth2Session #importe de metodos 
...
"""
  ...
  def login_failure(self, f):
    ...
    Función que nos demiuestra que se obtubo un fallo
    """
